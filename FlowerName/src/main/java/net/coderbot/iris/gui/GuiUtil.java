...
public final class GuiUtil {
	...
	public static void drawButton(MatrixStack poseStack, int x, int y, int width, int height, boolean hovered, boolean disabled) {
		...
		// Top left section
		AbstractGui.blit(poseStack, x, y, 0, vOffset, halfWidth, halfHeight, 256, 256);
		// Top right section
		AbstractGui.blit(poseStack, x + halfWidth, y, 200 - (width - halfWidth), vOffset, width - halfWidth, halfHeight, 256, 256);
		// Bottom left section
		AbstractGui.blit(poseStack, x, y + halfHeight, 0, vOffset + (20 - (height - halfHeight)), halfWidth, height - halfHeight, 256, 256);
		// Bottom right section
		AbstractGui.blit(poseStack, x + halfWidth, y + halfHeight, 200 - (width - halfWidth), vOffset + (20 - (height - halfHeight)), width - halfWidth, height - halfHeight, 256, 256);
	}
	...
	public static void playButtonClickSound() {
		client().getSoundManager().play(SimpleSound.forUI(SoundEvents.UI_BUTTON_CLICK, 1));
	}
}
