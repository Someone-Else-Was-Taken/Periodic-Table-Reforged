...
public interface UniformHolder {
	...
	UniformHolder uniform2i(UniformUpdateFrequency updateFrequency, String name, Supplier<Vector2f> value);
	...
	UniformHolder uniformJomlMatrix(UniformUpdateFrequency updateFrequency, String name, Supplier<Matrix4f> value);
