...
public abstract class MixinBufferBuilder_SeparateAo extends DefaultColorVertexBuilder {
	@Unique
	...
	@Override
	public void putBulkData(MatrixStack.Entry matrixEntry, BakedQuad quad, float[] brightnesses, float red, float green,
