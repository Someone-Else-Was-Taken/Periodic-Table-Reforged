...
public class FinalPassRenderer {
	...
	public FinalPassRenderer(ProgramSet pack, RenderTargets renderTargets, Texture noiseTexture,
	...
	public void renderFinalPass() {
		...
		final Framebuffer main = Minecraft.getInstance().getMainRenderTarget();
