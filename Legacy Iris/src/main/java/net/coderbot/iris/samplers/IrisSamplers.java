...
public class IrisSamplers {
	...
	public static void addNoiseSampler(SamplerHolder samplers, Texture texture) {
	...
	public static void addLevelSamplers(SamplerHolder samplers, Texture normals, Texture specular) {
