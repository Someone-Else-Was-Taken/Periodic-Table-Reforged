...
public class SodiumOptionsGUI extends Screen {
    ...
    private void rebuildGUIPages() {
        ...
        String shaderPacks = new TranslationTextComponent("options.iris.shaderPackSelection").getString();
        int shaderWidth = 12 + this.font.getStringWidth(shaderPacks);
        FlatButtonWidget irisButton = new FlatButtonWidget(new Dim2i(x, y, shaderWidth, 18), shaderPacks, () -> minecraft.displayGuiScreen(new ShaderPackScreen(this)));
